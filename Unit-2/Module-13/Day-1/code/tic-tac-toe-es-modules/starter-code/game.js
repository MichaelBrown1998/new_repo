...
// const {getString: readRequiredString, getInt: readInt} = require("./user-input.js");
// same as
// const userInputFunctions = require("./user-input.js");
// const {getString: readRequiredString, getInt: readInt} = userInputFunctions;
// same as
const userInputFunctions = require("./user-input.js");
const readRequiredString = userInputFunctions.getString;
const readInt = userInputFunctions.getInt;
