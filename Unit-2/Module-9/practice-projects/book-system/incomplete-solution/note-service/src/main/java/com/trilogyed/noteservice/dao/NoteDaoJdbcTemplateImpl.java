...
public class NoteDaoJdbcTemplateImpl implements NoteDao {
    ...
    // changes the thing that comes back from the database (a ResultSet) into our
    // DTO object (a Motorcycle)
    private Note mapRowToNote(ResultSet rs, int theNumberOfTheRow) throws SQLException {
        Note note = new Note();
